		...
		<form method="POST" action="editarproceso.php">
			<table>
				<tr>
					...
					<td><input type="text" name="txt2Nombre" class="form-control-lg2 border-0" value="<?php echo $item->nombre ?>" disabled></td>
				</tr>
				<tr>
					<td>Categoría: </td>
					<td><input type="text" name="txt2Categoria" class="form-control-lg2 border-0" value="<?php echo $item->categoria ?>" disabled></td>
				</tr>
				<tr>
					<td>Ingresos: </td>
					<td><input type="text" name="txt2Entradas" class="form-control-lg2 border-0" value="<?php echo $item->entradas ?>" disabled></td>
				</tr>
				<tr>
					<td>Egresos: </td>
					<td><input type="text" name="txt2Salidas" class="form-control-lg2 border-0" value="<?php echo $item->salidas ?>" disabled></td>
				</tr>
				<tr>
